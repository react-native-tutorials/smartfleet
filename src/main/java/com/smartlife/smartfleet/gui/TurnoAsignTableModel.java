 ...
 *
 */
public class TurnoAsignTableModel extends AbstractTableModel {
	...
	private String[] headers = new String[] {"ID", "TURNO", "OPERARIO", "FECHA","RAZON"};
	
	List<StateDetail> data = new ArrayList<>();
	/**
	 * 
	 */
	public TurnoAsignTableModel(List<StateDetail> data_) {
		super();
		data.addAll(data_);
	}
